...
Future<void> marcarAsistencia(String dni) async {
  ...
  if (res.statusCode == 200) {
    ...
    setState(() {
      ultimasAsistencias = List<Map<String, dynamic>>.from(data['asistencias'] ?? []);
    });
  }
}
...
Widget build(BuildContext context) {
  ...
  return Scaffold(
    ...
    body: Padding(
      ...
      child: SingleChildScrollView( // Asegura que todo sea visible
        child: Column(
          ...
          children: [
            ...
            if (ultimaAsistencia != null) ...[
              ...
              Text("👤 ${ultimaAsistencia!['nombre']} (${ultimaAsistencia!['dni']})"),
              Text("🕒 ${ultimaAsistencia!['hora']} - 📅 ${ultimaAsistencia!['fecha']}"),
            ],
